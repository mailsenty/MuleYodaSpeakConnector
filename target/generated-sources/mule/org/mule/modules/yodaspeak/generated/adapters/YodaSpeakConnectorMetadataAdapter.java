...
/**
 * A <code>YodaSpeakConnectorMetadataAdapter</code> is a wrapper around {@link YodaSpeakConnector } that adds support for querying metadata about the extension.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-07-01T12:47:14-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class YodaSpeakConnectorMetadataAdapter
    extends YodaSpeakConnectorCapabilitiesAdapter
    implements MetadataAware
{

    private final static String MODULE_NAME = "YodaSpeak";
