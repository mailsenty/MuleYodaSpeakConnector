...
public class GetYodaSpeakMessageProcessorDebuggable
    extends GetYodaSpeakMessageProcessor
    implements DebugInfoProvider
{


    public GetYodaSpeakMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("sentence", "Sentence", (java.lang.String.class), sentence, muleEvent));
